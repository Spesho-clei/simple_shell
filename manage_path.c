...
/**
 * if_file_exists - Checks file availability
 * @s: File name.
 * Return: 0 if the file exists, a non-zero value otherwise.
 */
...
/**
 * path_builder - Creates a path to binaries.
 * @tokens: Double pointer to tokens.
 * Return: The constructed path if it exists, NULL otherwise.
 */
